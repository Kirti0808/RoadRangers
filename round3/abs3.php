       ...
       <input type="button"  float="right" class="btn btn-primary" onclick="location.href='addedlist3.php'" value="CHECK ADDED ITEMS"/>
        ...
        <table class="table table-hover">
          ...
          <?php  } ?>
            ...
            <button class="btn btn-primary" onclick="location.href='steering3.php'" value="Continue" >CONTINUE</button>
            <button class="btn btn-primary" onclick="location.href='braking3.php'" value="Back" >BACK</button>
            </div>
        </body>
</html>