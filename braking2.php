...
<h4 style="font-family: Times, Times New Roman, serif; font-size: 2em;">
        ...
        <table class="table table-hover">
          ...
          <?php  } ?>
            ...
            <button class="btn btn-primary" onclick="location.href='abs2.php'" value="Continue" >CONTINUE</button>
            <button class="btn btn-primary" onclick="location.href='aero2.php'" value="Back" >BACK</button>
            </div>
        </body>
</html>