  ...
  <script src="auto-submit3.js"></script>
	...
	<body>
       ...
       <input type="button"  float="right" class="btn btn-primary" onclick="location.href='addedlist3.php'" value="CHECK ADDED ITEMS"/>
        ...
        <h4 style="font-family: Times, Times New Roman, serif; font-size: 2em;" class="text-danger">            3. SPOILERS
            </h4>
        <table class="table table-hover">
          ...
          <?php  } ?>
            ...
            <button class="btn btn-primary" onclick="location.href='aero3.php'" value="Continue" >CONTINUE</button>
            <button class="btn btn-primary" onclick="location.href='tyres3.php'" value="Back" >BACK</button>
            </div>
        </body>
</html>