       ...
       <input type="button"  float="right" class="btn btn-primary" onclick="location.href='addedlist2.php'" value="CHECK ADDED ITEMS"/>
        ...
        <table class="table table-hover">
          ...
          <?php  } ?>
            ...
            <button class="btn btn-primary" onclick="location.href='steering2.php'" value="Continue" >CONTINUE</button>
            <button class="btn btn-primary" onclick="location.href='braking2.php'" value="Back" >BACK</button>
            </div>
        </body>
</html>