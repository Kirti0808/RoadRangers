...
<html lang="en" class="no-js">
  ...
  <script src="auto-submit4.js"></script>
	...
	<body>
       ...
       <input type="button"  float="right" class="btn btn-primary" onclick="location.href='addedlist4.php'" value="CHECK ADDED ITEMS"/>
       </div>
                <?php
        $userid=$_SESSION['id'];
        ...
        <table class="table table-hover">
          ...
          <?php  } ?>
            ...
            <button class="btn btn-primary" onclick="location.href='steering4.php'" value="Continue" >CONTINUE</button>
            <button class="btn btn-primary" onclick="location.href='braking4.php'" value="Back" >BACK</button>
            </div>
        </body>
</html>