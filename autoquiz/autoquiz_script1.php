...
?>
           ...
           <div id="sign-form" class="sign-form">
             ...
             <?php  if($qid==1) { ?>
               <button class="btn btn-primary" onclick="location.href='autoquiz1.php?id=<?php echo $qid+1; ?>'" > NEXT QUESTION </button>
...
<?php
   ...
   <div  id="sign-form" class="sign-form">
               ...
               <button class="btn btn-primary" onclick="location.href='autoquiz1.php?id=<?php echo $qid; ?>'" > GO BACK </button>
