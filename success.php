...
<html>
    ...
    <body>
        ...
        <table class="table table-hover">
                ...
                <td></td>
                    ...
                    <br />
       <div class="btn-group">
        <input type="button" class="btn btn-warning" onclick="location.href='shop.php'" value="FIND PLAYERS"/>
 ...
 $user_id=$_SESSION['id'];
    ...
    if($no_of_rows==0)
    {
        ...
        <br />
        <?php
        echo "<h3>Add players to list first</h3>";
    }
    else{
        $sum=0;
        $c=0;
    ...
    <td><?php echo $sum; }  ?></td>
        ...
        <?php
        $sel="Select totalpoints,points1,points2,points3,points4 from users where id='$user_id'";
