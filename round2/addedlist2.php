...
<body>
    <div class="container">
	 <div>
             <button class="button button3" onclick="location.href='shop2.php'">Find items</button>
 ...
 $user_id=$_SESSION['id'];
        ...
        while($row= mysqli_fetch_array($select_query_res))
    {
        ...
        ?>
                ...
                if($arr[0]==11){
               ?>
									<td><button class="button button3" onclick="location.href='success2.php'">Confirm</button></td>
                <?php } ?>
                                                                </tr>
