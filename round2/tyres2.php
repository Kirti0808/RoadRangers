...
<html lang="en" class="no-js">
  ...
  <script src="auto-submit22.js"></script>
       ...
       <input type="button"  float="right" class="btn btn-primary" onclick="location.href='addedlist2.php'" value="CHECK ADDED ITEMS"/>
        ...
        <table class="table table-hover">
          ...
          <?php  } ?>
            ...
            <button class="btn btn-primary" onclick="location.href='spoilers2.php'" value="Continue" >CONTINUE</button>
            <button class="btn btn-primary" onclick="location.href='shop2.php'" value="Back" >BACK</button>
            </div>
        </body>
</html>