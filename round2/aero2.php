...
<!--<![endif]-->
	<head>
        ...
        ?>
            ...
            <div class="flex flex-1 flex-col md:px-4 pt-25" id="content">
				...
				<div class="px-6 md:px-0 flex justify-between items-center -order-1">
					...
					<button class="bg-indigo-dark hover:bg-indigo-darker text-white text-sm py-2 px-4 rounded-full transition-normal hover:shadow hover:translate-y-1 active:translate-y-1 focus:outline-none" onclick="location.href='addedlist2.php'">Check added list</button>
				</div>
        ...
        <div class="hidden px-6 md:px-0 mt-4 md:flex flex-wrap order-1 md:-order-1 md:shadow-md js-tab-pane " id="section-stats">
            ...
            <td> <button class="bg-indigo-dark hover:bg-indigo-darker text-white text-sm py-2 px-4 rounded-full transition-normal hover:shadow hover:translate-y-1 active:translate-y-1 focus:outline-none" class="disabled" onclick="location.href='additem2.php?id=<?php echo $row1[0]; ?>'" value="ADD ITEM"  >ADD ITEM</a></button></td>
            <?php } } }?>
                                                        </tbody>
        </table>
            <br />
             <button class="bg-indigo-dark hover:bg-indigo-darker text-white text-sm py-2 px-4 rounded-full transition-normal hover:shadow hover:translate-y-1 active:translate-y-1 focus:outline-none" onclick="location.href='spoilers2.php'" value="Continue" >BACK</button>
           
            <button class="bg-indigo-dark hover:bg-indigo-darker text-white text-sm py-2 px-4 rounded-full transition-normal hover:shadow hover:translate-y-1 active:translate-y-1 focus:outline-none" onclick="location.href='braking2.php'" value="Continue" >CONTINUE</button>
            </div>
